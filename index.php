...
<div class="container">
    <div class="single">  
       ...
       $sql ="SELECT jobs.jobid, jobs.name, categories.name AS 'catname' ,jobs.description,jobs.skill,jobs.timing,jobs.date,jobs.salary,jobs.location FROM jobs INNER JOIN categories ON  jobs.catid = categories.catid ORDER BY jobs.jobid DESC LIMIT 3";
     ...
     <div class="col-md-4 icon-service">
		...
		?>
		<center>
		<a href="viewjobs.php" class="btn btn-primary">View jobs</a>
	</center>
      </div>
	</div>
</div>
